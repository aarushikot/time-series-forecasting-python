...
In order to obtain an exact copy of the dataset used in this tutorial, please run the [script](https://github.com/aarushikot/time-series-forecasting-wiki/blob/master/datasets/download_datasets.py) under "datasets/download_datasets.py" which will automatically download the dataset and preprocess it for you.
...
We will divide our results based on whether the extra feature columns, such as temperature or pressure, were used by the model, as this is a significant step in metrics and represents two different scenarios. Metrics used were:
...
There are several models we have not tried in this tutorial as they come from the academic world and their implementation is not 100% reliable, but it is worth mentioning them:
...
# Contributing
If you would like to see another model tested or have suggestions for improvements, I would be happy to discuss them. Please feel free to open an issue or a pull request.

# Maintainer
Aarushi Kotwani is a Data Professional with over four years of experience in data engineering, analytics, and machine learning. She specializes in building automated ETL pipelines and developing interactive analytical models to drive business outcomes.
